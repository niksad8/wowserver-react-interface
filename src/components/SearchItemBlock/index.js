...
class SearchItemBlock extends Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        <tr>
                            <td style={{padding:0}}>
                                <div className='mediumicon'>
                                    <div style={{width:36, height:36, left:4, top:4, "backgroundImage":"url(https://web-auctioneer.com/images/ICONS/"+this.state.icon+".png)"}}/>
                                </div>
                            </td>
                            <td style={{padding:0}}>
...
export default withRouter(SearchItemBlock);